...
# #TODO remove
# parser.add_argument(
#     "--dataset_type", choices=["tripe", "quadruple", "quintuple", "quintuple_Loc", "quintuple_Tim"], default="triple",
#     help="Dataset_type"
# )
...
def train(args):
    ...
    device = "cuda:"+str(args.cuda_n)
    cuda1 = torch.device('cuda:'+str(args.cuda_n))
    model.to(device)
    #print(model.entity)
    #torch.save(model.entity, 'entity.pkl')
    #exit()

    # get optimizer
    regularizer = getattr(regularizers, args.regularizer)(args.reg)
    optim_method = getattr(torch.optim, args.optimizer)(model.parameters(), lr=args.learning_rate)
    optimizer = KGOptimizer(args, cuda1, model, regularizer, optim_method, args.batch_size, args.neg_sample_size,
